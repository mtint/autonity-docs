...
Autonity network permissioning features follow a modular architecture, composed of two main components: **Soma**, which manages the validator set governance and **Glienicke**, that controls the node permissioning at the P2P network level.
